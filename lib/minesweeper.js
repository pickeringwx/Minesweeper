...
class Game {
  ...
  playMove(rowIndex, columnIndex) {
    ...
    // Technically, a typo (you have "hasSafeTitles" instead of "hasSafeTiles"), but you
    // use it as its written, so it's up to you if you really want to change it.
    // Changed: You'll want to display the win condition if there are no safe tiles left.
